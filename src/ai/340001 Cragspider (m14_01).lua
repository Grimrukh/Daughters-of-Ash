--@package: m14_01_00_00.luabnd, 340001_battle.lua
--@battle_goal: 340001, KuraguSpider_Child340001Battle
...
KuraguSpider_Child340001Battle_Activate = function(ai, goal)
   ...
   if func1_var12 <= func1_var6 then
      KuraguSpider_Child340001_Act01(ai, goal)
      func1_var11 = 100
   elseif func1_var12 <= func1_var6 + func1_var7 then
      KuraguSpider_Child340001_Act02(ai, goal)
      func1_var11 = 0
   elseif func1_var12 <= func1_var6 + func1_var7 + func1_var8 then
      KuraguSpider_Child340001_Act03(ai, goal)
      func1_var11 = 0
   elseif func1_var12 <= func1_var6 + func1_var7 + func1_var8 + func1_var9 then
      KuraguSpider_Child340001_Act04(ai, goal)
      func1_var11 = 0
   else
      KuraguSpider_Child340001_Act05(ai, goal)
      func1_var11 = 100
   end
   local func1_var13 = ai:GetRandam_Int(1, 100)
   if func1_var13 <= func1_var11 then
      KuraguSpider_Child340001_ActAfter_AdjustSpace(ai, goal, paramTbl)
   end
end

KuraguSpider_Child340001_Act01 = function(ai, goal)
...
KuraguSpider_Child340001_Act02 = function(ai, goal)
...
KuraguSpider_Child340001_Act03 = function(ai, goal)
...
KuraguSpider_Child340001_Act04 = function(ai, goal)
...
KuraguSpider_Child340001_Act05 = function(ai, goal)
...
KuraguSpider_Child340001_ActAfter_AdjustSpace = function(ai, goal, func7_param2)
...
KuraguSpider_Child340001Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

KuraguSpider_Child340001Battle_Terminate = function(ai, goal)
end

KuraguSpider_Child340001Battle_Interupt = function(ai, goal)
