--@package: m12_01_00_00.luabnd, 006020_battle.lua
--@battle_goal: 6020, Knight_Ostra6020Battle
...
local localScriptConfigVar14 = 4.5
local localScriptConfigVar15 = 5.5
local localScriptConfigVar16 = 0
local localScriptConfigVar17 = 0.8
Knight_Ostra6020Battle_Activate = function(ai, goal)
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act02)
   func1_var3[5] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act05)
   func1_var3[7] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act07)
   func1_var3[9] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act09)
   func1_var3[10] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act10)
   func1_var3[13] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act13)
   func1_var3[15] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act15)
   func1_var3[17] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act17)
   func1_var3[18] = REGIST_FUNC(ai, goal, Knight_Ostra6020_Act18)
   local func1_var11 = REGIST_FUNC(ai, goal, Knight_Ostra6020_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var11, func1_var4)
end

Knight_Ostra6020_Act01 = function(ai, goal, func2_param2)
...
Knight_Ostra6020_Act02 = function(ai, goal, func3_param2)
...
Knight_Ostra6020_Act05 = function(ai, goal, func4_param2)
...
Knight_Ostra6020_Act07 = function(ai, goal, func5_param2)
...
Knight_Ostra6020_Act09 = function(ai, goal, func6_param2)
...
Knight_Ostra6020_Act10 = function(ai, goal, func7_param2)
...
Knight_Ostra6020_Act13 = function(ai, goal, func8_param2)
...
Knight_Ostra6020_Act15 = function(ai, goal, func9_param2)
...
Knight_Ostra6020_Act17 = function(ai, goal, func10_param2)
...
Knight_Ostra6020_Act18 = function(ai, goal, func11_param2)
...
Knight_Ostra6020_ActAfter_AdjustSpace = function(ai, goal, func12_param2)
