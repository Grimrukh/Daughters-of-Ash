--@package: m16_00_00_00.luabnd, 250002_battle.lua
--@battle_goal: 250002, Husi_Torch250002Battle
...
Husi_Torch250002Battle_Activate = function(ai, goal)
   local func1_var2 = {}
   local func1_var3 = {}
   local func1_var4 = {}
   ...
   func1_var6 = func1_var6(ai, goal, Husi_Torch250002_Act07)
...
Husi_Torch250002_Act07 = function(ai, goal, func2_param2)
...
Husi_Torch250002Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

Husi_Torch250002Battle_Terminate = function(ai, goal)
end

Husi_Torch250002Battle_Interupt = function(ai, goal)
