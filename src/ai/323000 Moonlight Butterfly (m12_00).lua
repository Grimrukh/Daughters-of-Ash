--@package: m12_00_00_00.luabnd, 323000_battle.lua
--@battle_goal: 323000, Kagerou323000Battle

OnIf_323000 = function(ai, goal, ifSlot)
   if ifSlot == 0 then
      local bastionDead = ai:GetEventRequest(0)
      if bastionDead then
         ai:SetTimer(0, 30)
         ai:SetTimer(1, 15)
      else
