--@package: m10_01_00_00.luabnd, 237000_battle.lua
--@battle_goal: 237000, FourKnightD237000Battle

-- 3000: Thrust stab
-- 3001: Walking thrust stab
-- 3002: Two-handed backswing
-- 3003: One-handed foreswing
-- 3004: One-handed backswing (from 3003)
-- 3005: Soul Arrow (short charge)
-- 3006: Soul Arrow (long charge)
-- 3007: Buff dance
-- 3008: Teleport
-- 3009: Spinning one-handed thrust
...
FourKnightD237000Battle_Activate = function(ai, goal)
   ...
   if ai:ChkNearLowHpFriend(1, 20) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1012776) and not ai:HasSpecialEffectId(TARGET_SELF, 5470) then
      -- Buff dance, seems to trigger if you hurt a nearby "friend" (Hollow).
      -- New: now triggers when player is in area 1012776 (downstairs) rather than upstairs in 1012775.
      if distanceToEnemy >= 8 then
         func1_var2[5] = 900
      elseif distanceToEnemy >= 4 then
         func1_var2[5] = 50
      elseif distanceToEnemy >= 2.5 then
         func1_var2[5] = 45
      else
         func1_var2[5] = 20
      end
   ...
   if ai:IsInsideTargetRegion(TARGET_SELF, 1012775) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1012776) then
      -- Channeler is upstairs, player is downstairs and in range --> Soul Arrow (fast or slow).
      func1_var2[1] = 40
      func1_var2[3] = 60
   elseif ai:IsInsideTargetRegion(TARGET_SELF, 1012775) and ai:IsInsideTargetRegion(TARGET_ENE_0, 1012777) then
      -- Channeler is upstairs, player is downstairs (but not in range) --> do nothing.
      func1_var2[6] = 100
   elseif distanceToEnemy >= 8 then
      func1_var2[1] = 40
      func1_var2[2] = 0
      func1_var2[3] = 60
      func1_var2[4] = 0
   ...
   func1_var3[1] = REGIST_FUNC(ai, goal, FourKnightD237000_Act01)  -- Fast Soul Arrow.
   local func1_var8 = {localScriptConfigVar1, 0, 20, 40, nil, nil, nil, nil}
   func1_var4[2] = func1_var8
   func1_var8 = REGIST_FUNC
   func1_var8 = func1_var8(ai, goal, FourKnightD237000_Act03)  -- Slow Soul Arrow.
   func1_var3[3] = func1_var8
   func1_var8 = REGIST_FUNC
   func1_var8 = func1_var8(ai, goal, FourKnightD237000_Act04)  -- Evade/back off.
   func1_var3[4] = func1_var8
   func1_var8 = REGIST_FUNC
   func1_var8 = func1_var8(ai, goal, FourKnightD237000_Act05)  -- Buff dance.
   func1_var3[5] = func1_var8
   func1_var8 = REGIST_FUNC
   func1_var8 = func1_var8(ai, goal, FourKnightD237000_Act06)  -- Just wait.
   func1_var3[6] = func1_var8
   func1_var8 = REGIST_FUNC
   func1_var8 = func1_var8(ai, goal, FourKnightD237000_Act07)  -- Spinning thrust.
