--@package: m14_00_00_00.luabnd, 006860_battle.lua
--@battle_goal: 6860, SellswordTishanna6860Battle

-- Just a copy of the Ninja.
...
SellswordTishanna6860Battle_Activate = function(ai, goal)
   ai:StartDash()
   local func1_var2 = {}
   local func1_var3 = {}
   local func1_var4 = {}
   ...
   -- Tried to add an 'end' here but it's incorrect
   func1_var3[1] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act02)
   func1_var3[3] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act03)
   func1_var3[4] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act04)
   func1_var3[5] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act05)
   func1_var3[6] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act06)
   func1_var3[7] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act07)
   func1_var3[8] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act08)
   func1_var3[9] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act09)
   func1_var3[10] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act10)
   func1_var3[11] = REGIST_FUNC(ai, goal, SellswordTishanna6860_Act11)
   local func1_var9 = REGIST_FUNC(ai, goal, SellswordTishanna6860_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var9, func1_var4)
end

SellswordTishanna6860_Act01 = function(ai, goal, func2_param2)
...
SellswordTishanna6860_Act02 = function(ai, goal, func3_param2)
...
SellswordTishanna6860_Act03 = function(ai, goal, func4_param2)
...
SellswordTishanna6860_Act04 = function(ai, goal, func5_param2)
...
SellswordTishanna6860_Act05 = function(ai, goal, func6_param2)
...
SellswordTishanna6860_Act06 = function(ai, goal, func7_param2)
...
SellswordTishanna6860_Act07 = function(ai, goal, func8_param2)
...
SellswordTishanna6860_Act08 = function(ai, goal, func9_param2)
...
SellswordTishanna6860_Act09 = function(ai, goal, func10_param2)
...
SellswordTishanna6860_Act10 = function(ai, goal, func11_param2)
...
SellswordTishanna6860_Act11 = function(ai, goal, func12_param2)
...
SellswordTishanna6860_Battle_Attack_After = function(ai, goal)
...
SellswordTishanna6860Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

SellswordTishanna6860Battle_Terminate = function(ai, goal)
end

SellswordTishanna6860Battle_Interupt = function(ai, goal)
