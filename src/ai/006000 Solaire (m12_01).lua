--@package: m12_01_00_00.luabnd, 006000_battle.lua
--@battle_goal: 6000, Knight_of_Sun6000Battle
...
Knight_of_Sun6000Battle_Activate = function(ai, goal)
   ...
   if func1_var8 >= 8 then
      func1_var2[1] = 5
      func1_var2[3] = 5
      func1_var2[5] = 45 * func1_var9
      func1_var2[7] = 40
      func1_var2[10] = 5
   elseif func1_var8 >= 5 then
      func1_var2[1] = 15
      func1_var2[3] = 15
      func1_var2[5] = 35 * func1_var9
      func1_var2[7] = 30
      func1_var2[10] = 5
   ...
   -- Tried to add an 'end' here but it's incorrect
   func1_var3[1] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act01)
   func1_var3[2] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act02)
   func1_var3[3] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act03)
   func1_var3[4] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act04)
   func1_var3[5] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act05)
   func1_var3[6] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act06)
   func1_var3[7] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act07)
   func1_var3[8] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act08)
   func1_var3[9] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act09)
   func1_var3[10] = REGIST_FUNC(ai, goal, Knight_of_Sun6000_Act10)
   local func1_var11 = REGIST_FUNC(ai, goal, Knight_of_Sun6000_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var11, func1_var4)
end

Knight_of_Sun6000_Act01 = function(ai, goal, func2_param2)
...
Knight_of_Sun6000_Act02 = function(ai, goal, func3_param2)
...
Knight_of_Sun6000_Act03 = function(ai, goal, func4_param2)
...
Knight_of_Sun6000_Act04 = function(ai, goal, func5_param2)
...
Knight_of_Sun6000_Act05 = function(ai, goal, func6_param2)
...
Knight_of_Sun6000_Act06 = function(ai, goal, func7_param2)
...
Knight_of_Sun6000_Act07 = function(ai, goal, func8_param2)
...
Knight_of_Sun6000_Act08 = function(ai, goal, func9_param2)
...
Knight_of_Sun6000_Act09 = function(ai, goal, func10_param2)
...
Knight_of_Sun6000_Act10 = function(ai, goal, func11_param2)
...
Knight_of_Sun6000_ActAfter_AdjustSpace = function(ai, goal, func12_param2)
   ...
   if ai:IsInterupt(INTERUPT_Shoot) then
      ...
      if func15_var3 <= func15_var6 then
         ...
         if func15_var3 <= 50 then
            ...
            local func15_var7 = localScriptConfigVar5
            local func15_var8 = localScriptConfigVar5 + 5
