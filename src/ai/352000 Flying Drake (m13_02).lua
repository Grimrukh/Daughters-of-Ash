--@package: m13_02_00_00.luabnd, 352000_battle.lua
--@battle_goal: 352000, wyvern352000Battle
...
wyvern352000Battle_Activate = function(ai, goal)
   ...
   local verticalDistanceFromEnemy = ai:GetDistYSigned(TARGET_ENE_0)
   local absoluteVerticalDistance = ai:GetDistY(TARGET_ENE_0)
   local func1_var12 = 0
   local func1_var13 = 0
   local func1_var14 = 0
   local func1_var15 = 0
   ...
   local func1_var19 = 0
   local patrolOdds = 0
   local enemyWithinRegion = 0
   if ai:IsInsideTargetRegion(TARGET_ENE_0, 1512700) or ai:IsInsideTargetRegion(TARGET_ENE_0, 1322875) or
           ai:IsInsideTargetRegion(TARGET_ENE_0, 1602675) then
      -- Enemy is within attack region.
      enemyWithinRegion = 1
   end
   local func1_var22 = 0
   if verticalDistanceFromEnemy <= -4 and verticalDistanceFromEnemy >= -7 then
      func1_var22 = 1
   end
   local func1_var23 = 0
   ...
   if enemyWithinRegion == 0 then
      patrolOdds = 100
   elseif func1_var22 == 0 then
      func1_var19 = 100
   elseif absoluteVerticalDistance * 2 <= func1_var9 then
      func1_var12 = 0
      func1_var13 = 5
      func1_var14 = 25
      func1_var15 = 70
      func1_var18 = 0
   elseif absoluteVerticalDistance <= func1_var9 then
      func1_var12 = 5
      func1_var13 = 20
      func1_var14 = 75
      func1_var15 = 0
      func1_var18 = 0
   elseif absoluteVerticalDistance * 0.5 <= func1_var9 then
      func1_var12 = 15
      func1_var13 = 75
      func1_var14 = 0
      func1_var15 = 0
   ...
   local func1_var24 = ai:GetRandam_Int(1, func1_var12 + func1_var13 + func1_var14 + func1_var15 + func1_var16 + func1_var17 + func1_var18 + func1_var19 + patrolOdds)
