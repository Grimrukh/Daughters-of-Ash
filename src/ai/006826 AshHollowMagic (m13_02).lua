--@package: m13_02_00_00.luabnd, 006826_battle.lua
--@battle_goal: 6826, AshHollow6826Battle
...
AshHollow6826Battle_Activate = function(ai, goal)
   local func1_var2 = {}
   local func1_var3 = {}
   local func1_var4 = {}
   ...
   func1_var3[3] = REGIST_FUNC(ai, goal, AshHollow6826_Act03)
   func1_var3[4] = REGIST_FUNC(ai, goal, AshHollow6826_Act04)
   func1_var3[6] = REGIST_FUNC(ai, goal, AshHollow6826_Act06)
   func1_var3[17] = REGIST_FUNC(ai, goal, AshHollow6826_Act17)
   func1_var3[18] = REGIST_FUNC(ai, goal, AshHollow6826_Act18)
   func1_var3[19] = REGIST_FUNC(ai, goal, AshHollow6826_Act19)
   func1_var3[20] = REGIST_FUNC(ai, goal, AshHollow6826_Act20)
   local func1_var16 = REGIST_FUNC(ai, goal, AshHollow6826_ActAfter_AdjustSpace, atkAfterOddsTbl)
   Common_Battle_Activate(ai, goal, func1_var2, func1_var3, func1_var16, func1_var4)
end

AshHollow6826_Act03 = function(ai, goal, func2_param2)
...
AshHollow6826_Act04 = function(ai, goal, func3_param2)
...
AshHollow6826_Act06 = function(ai, goal, func4_param2)
...
AshHollow6826_Act17 = function(ai, goal, func5_param2)
...
AshHollow6826_Act18 = function(ai, goal, func6_param2)
...
AshHollow6826_Act19 = function(ai, goal, func7_param2)
...
AshHollow6826_Act20 = function(ai, goal, func8_param2)
...
AshHollow6826_ActAfter_AdjustSpace = function(ai, goal, func9_param2)
   local func9_var3 = ai:GetRandam_Int(1, 100)
   local func9_var4 = ai:GetRandam_Int(1, 100)
   local func9_var5 = 3
   if func9_var3 <= 40 then
      goal:AddSubGoal(GOAL_COMMON_SpinStep, 10, NPC_ATK_BackstepB, TARGET_ENE_0, 0, AI_DIR_TYPE_B, 2)
   else
   end
end

AshHollow6826Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

AshHollow6826Battle_Terminate = function(ai, goal)
end

AshHollow6826Battle_Interupt = function(ai, goal)
