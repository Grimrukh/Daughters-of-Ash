--@package: m18_00_00_00.luabnd, 410003_battle.lua
--@battle_goal: 410003, Artorius410003Battle
...
OnIf_410003 = function(ai, goal, if_switch)
   if if_switch == 0 then
      ai:SetTimer(0, 40)
   end
   if if_switch == 1 then
   ...
   if if_switch == 2 then
      Artorius410003_ActAfter(ai, goal)
   end
   if if_switch == 3 then
      ai:SetTimer(2, 10)
   end
...
Artorius410003Battle_Activate = function(ai, goal)
   local func2_var2 = {}
   local func2_var3 = {}
   local func2_var4 = {}
...
--      func2_var2[12] = 100
   ...
   func2_var3[1] = REGIST_FUNC(ai, goal, Artorius410003_Act01)
   func2_var3[2] = REGIST_FUNC(ai, goal, Artorius410003_Act02)
   func2_var3[3] = REGIST_FUNC(ai, goal, Artorius410003_Act03)
   func2_var3[4] = REGIST_FUNC(ai, goal, Artorius410003_Act04)
   func2_var3[5] = REGIST_FUNC(ai, goal, Artorius410003_Act05)
   func2_var3[6] = REGIST_FUNC(ai, goal, Artorius410003_Act06)
   func2_var3[7] = REGIST_FUNC(ai, goal, Artorius410003_Act07)
   func2_var3[8] = REGIST_FUNC(ai, goal, Artorius410003_Act08)
   func2_var3[9] = REGIST_FUNC(ai, goal, Artorius410003_Act09)
   func2_var3[10] = REGIST_FUNC(ai, goal, Artorius410003_Act10)
   func2_var3[11] = REGIST_FUNC(ai, goal, Artorius410003_Act11)
   func2_var3[12] = REGIST_FUNC(ai, goal, Artorius410003_Act12)
   func2_var3[13] = REGIST_FUNC(ai, goal, Artorius410003_Act13)
   func2_var3[20] = REGIST_FUNC(ai, goal, Artorius410003_Act20)
   local func2_var10 = REGIST_FUNC(ai, goal, Artorius410003_ActAfter_AdjustSpace)
   Common_Battle_Activate(ai, goal, func2_var2, func2_var3, func2_var10, func2_var4)
end

Artorius410003_Act01 = function(ai, goal, func3_param2)
...
Artorius410003_Act02 = function(ai, goal, func4_param2)
   -- Slam and followups.
...
Artorius410003_Act03 = function(ai, goal, func5_param2)
   -- Lunging thrust.
...
Artorius410003_Act04 = function(ai, goal, func6_param2)
   -- Sliding swing and possible double spin.
...
Artorius410003_Act05 = function(ai, goal, func7_param2)
   -- Jump smash.
   -- TODO:
...
Artorius410003_Act06 = function(ai, goal, func8_param2)
...
Artorius410003_Act07 = function(ai, goal, func9_param2)
...
Artorius410003_Act08 = function(ai, goal, func10_param2)
...
Artorius410003_Act09 = function(ai, goal, func11_param2)
...
Artorius410003_Act10 = function(ai, goal, func12_param2)
...
Artorius410003_Act11 = function(ai, goal, func13_param2)
...
Artorius410003_Act12 = function(ai, goal, func14_param2)
   -- TODO: Turn into something else (a new combo).
...
Artorius410003_Act13 = function(ai, goal, func15_param2)
   -- Thrust and possible followups.
...
Artorius410003_Act20 = function(ai, goal, func16_param2)
   -- Strafes away.
...
Artorius410003_ActAfter = function(ai, goal)
...
Artorius410003_ActAfter_AdjustSpace = function(ai, goal, func18_param2)
   goal:AddSubGoal(GOAL_COMMON_If, 10, 2)
end

Artorius410003Battle_Update = function(ai, goal)
   return GOAL_RESULT_Continue
end

Artorius410003Battle_Terminate = function(ai, goal)
end

Artorius410003Battle_Interupt = function(ai, goal)
